...
declare const RecordsTable: React.ComponentType<RecordsTableProps & {
    OriginalComponent?: React.FunctionComponent<RecordsTableProps> | React.ComponentClass<RecordsTableProps, any> | undefined;
}>;
export { RecordsTable };

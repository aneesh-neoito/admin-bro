...
declare const buildActionClickHandler: (options: BuildActionClickOptions) => BuildActionClickReturn;
export { buildActionClickHandler as default, buildActionClickHandler };

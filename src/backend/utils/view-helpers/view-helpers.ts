...
export class ViewHelpers {
   ...
   * @return {string}
   */
   publicPageUrl(pageName: string): string {
  ...
  resourceActionUrl({
    ...
    actionName,
    search,
  }: ResourceActionParams): string {
    return this.urlBuilder(
      ['resources', resourceId, 'actions', actionName],
      search,
    );
  }
  ...
  resourceUrl({
    resourceId,
    search,
  }: Omit<ResourceActionParams, 'actionName'>): string {
  ...
  recordActionUrl({
    ...
    return this.urlBuilder(
      ['resources', resourceId, 'records', recordId, actionName],
      search,
    );
  }

 ...
 */
export type LayoutElementFunction = (
...
const hasFirstStringProperty = function (
  layoutElement: LayoutElement,
): boolean {
  return (
    Array.isArray(layoutElement) &&
...
export const layoutElementParser = (
  layoutElement: LayoutElement,
): ParsedLayoutElement => {

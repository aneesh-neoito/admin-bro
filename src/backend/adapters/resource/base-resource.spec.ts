...
describe('BaseResource', function () {
  ...
  describe('#property', function () {
    it('throws NotImplementedError', async function () {
      expect(() => resource.property('someProperty')).to.throw(
        NotImplementedError,
      );
    });
  });
  ...
  describe('#count', function () {
    it('throws NotImplementedError', async function () {
      expect(resource.count({} as Filter)).to.be.rejectedWith(
        NotImplementedError,
      );
    });
  });
  ...
  describe('#find', function () {
    it('throws NotImplementedError', async function () {
      expect(resource.find({} as Filter, {})).to.be.rejectedWith(
        NotImplementedError,
      );
    });
  });
  ...
  describe('#findOne', function () {
    it('throws NotImplementedError', async function () {
      expect(resource.findOne('someId')).to.be.rejectedWith(
        NotImplementedError,
      );
    });
  });
  ...
  describe('#decorate', function () {
    ...
    it('throws error when resource has not been decorated', function () {
      expect(() => resource.decorate()).to.throw(
        'resource does not have any assigned decorator yet',
      );
    });
  });
});

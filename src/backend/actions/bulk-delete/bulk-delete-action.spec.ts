  ...
  describe('.handler', function () {
    ...
    context('2 records were selected', function () {
      ...
      it('deletes all records for post request', async function () {
        ...
        await (BulkDeleteAction.handler as ActionHandler<BulkActionResponse>)(
          request,
          response,
          data,
        );
      ...
      it('returns deleted records, notice and redirectUrl for post request', async function () {
        ...
        const actionResponse = await (BulkDeleteAction.handler as ActionHandler<BulkActionResponse>)(
          request,
          response,
          data,
        );

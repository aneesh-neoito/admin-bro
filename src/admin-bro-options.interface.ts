 ...
 *   impersonatePath: '/xyz-admin/impersonate',
 *   impersonateLogoutPath: '/xyz-admin/impersonate/exit',
 *   loginPath: '/xyz-admin/sign-in',
 *   signupPath: '/xyz-admin/signup',
 *   forgotPasswordPath: '/xyz-admin/forgot-password',
 *   changePasswordPath: '/xyz-admin/change-password',
...
export interface AdminBroOptions {
  ...
  logoutPath?: string;
  /**
   * url to a impersonate action, default to `/admin/impersonate`
   */
  impersonatePath?: string;
  /**
   * url to a logout an impersonate action, default to `/admin/impersonate/logout`
   */
  impersonateLogoutPath?: string;
  /**
   * url to a login page, default to `/admin/login`
   */
  loginPath?: string;
  /**
   * url to a signup page, default to `/admin/signup`
   */
  signupPath?: string;
  /**
   * url to a forgot password page, default to `/admin/forgot-password`
   */
  forgotPasswordPath?: string;
  /**
   * url to a change password page, default to `/admin/change-password`
   */
  ...
  /**
   * Option to modify the login
   */
  login?: {
    /**
     * Bundled component name which should be rendered when user opens the login
     */
    component?: string;
  };
  /**

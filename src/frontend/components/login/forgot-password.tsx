...
const ForgotPasswordOriginal: React.FC<ForgotPasswordProps> = (props) => {
  const { action } = props
    ...
    <Wrapper flex variant="grey">
      <Box bg="white" height="440px" flex boxShadow="login" width={[1, 2 / 3, 'auto']}>
        ...
        >
          ...
          <Text mt="xl" textAlign="center">Forgot password not implemented yet.</Text>
        </Box>
      </Box>
...
const ForgotPassword = allowOverride(ForgotPasswordOriginal, 'ForgotPassword')

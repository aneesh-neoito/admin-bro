...
var _getSubmitForm = require("./utils/get-submit-form");
...
const New = props => {
  ...
  const useRecordHook = (0, _useRecord.default)(initialRecord, resource.id);
  const {
    record,
    handleChange,
    submit: handleSubmit,
  ...
  const content = /*#__PURE__*/_react.default.createElement(_designSystem.Box, null, action !== null && action !== void 0 && action.showInDrawer ? /*#__PURE__*/_react.default.createElement(_actionHeader.default, props) : null, action.layout ? action.layout.map((layoutElement, i) => /*#__PURE__*/_react.default.createElement(_layoutElementRenderer.default // eslint-disable-next-line react/no-array-index-key
  , _extends({
    key: i,
  ...
  }, content, (0, _getSubmitForm.submitForm)({
    props,
    loading
  }));
};

...
const Wrapper = (0, _styledComponents.default)(_designSystem.Box).withConfig({
  displayName: "forgot-password__Wrapper",
  componentId: "w4phas-0"
...
const ForgotPasswordOriginal = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(Wrapper, {
    ...
    mt: "xl",
    textAlign: "center"
  }, "Forgot password not implemented yet."))), branding.softwareBrothers ? /*#__PURE__*/_react.default.createElement(_designSystem.Box, {
    mt: "xxl"
  }, /*#__PURE__*/_react.default.createElement(_designSystem.SoftwareBrothers, null)) : null);
};

const ForgotPassword = (0, _allowOverride.default)(ForgotPasswordOriginal, 'ForgotPassword');

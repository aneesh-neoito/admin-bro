...
const Wrapper = (0, _styledComponents.default)(_designSystem.Box).withConfig({
  displayName: "change-password__Wrapper",
  componentId: "sc-23muzi-0"
...
const StyledLogo = _styledComponents.default.img.withConfig({
  displayName: "change-password__StyledLogo",
  componentId: "sc-23muzi-1"
})(["max-width:200px;margin:", " 0;"], (0, _designSystem.themeGet)('space', 'md'));

const ChangePasswordOriginal = props => {
  const {
    action
  } = props;
  const {
  ...
  return /*#__PURE__*/_react.default.createElement(Wrapper, {
    ...
    mt: "xl",
    textAlign: "center"
  }, "Change password not implemented yet."))), branding.softwareBrothers ? /*#__PURE__*/_react.default.createElement(_designSystem.Box, {
    mt: "xxl"
  }, /*#__PURE__*/_react.default.createElement(_designSystem.SoftwareBrothers, null)) : null);
};

const ChangePassword = (0, _allowOverride.default)(ChangePasswordOriginal, 'ChangePassword');

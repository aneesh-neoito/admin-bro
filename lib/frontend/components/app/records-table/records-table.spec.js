...
describe('<RecordsTable />', function () {
  ...
  context('10 records are given without bulk and list actions', function () {
    beforeEach(async function () {
      ...
      const total = (_records$length = (_records = records) === null || _records === void 0 ? void 0 : _records.length) !== null && _records$length !== void 0 ? _records$length : 0;
      ({
        container
      } = renderSubject({
        total,
  ...
  context('10 records are given with bulk delete and show actions', function () {
    beforeEach(async function () {
      var _records$length2, _records2;
      ...
      const total = (_records$length2 = (_records2 = records) === null || _records2 === void 0 ? void 0 : _records2.length) !== null && _records$length2 !== void 0 ? _records$length2 : 0;
      ({
        container
      } = renderSubject({
        total,

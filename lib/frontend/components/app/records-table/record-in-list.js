...
const RecordInList = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_designSystemWrapper.TableRow, {
    onClick: handleClick,
    "data-id": record.id
    ...
    checked: isSelected
  }) : null), resource.listProperties.map(property => /*#__PURE__*/_react.default.createElement(_designSystemWrapper.TableCell, {
    style: {
      cursor: 'pointer'
    },

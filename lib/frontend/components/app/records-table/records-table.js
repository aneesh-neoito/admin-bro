...
const RecordsTableOriginal = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_designSystemWrapper.Table, null, /*#__PURE__*/_react.default.createElement(_selectedRecords.default, {
    resource: resource,
  ...
  }), /*#__PURE__*/_react.default.createElement(_designSystemWrapper.TableBody, null, records.map(record => /*#__PURE__*/_react.default.createElement(_recordInList.default, {
    record: record,
    resource: resource,
    key: record.id,
...
const RecordsTable = (0, _allowOverride.default)(RecordsTableOriginal, 'RecordsTable');

...
const RecordsTableHeader = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_designSystemWrapper.TableHead, null, /*#__PURE__*/_react.default.createElement(_designSystemWrapper.TableRow, null, /*#__PURE__*/_react.default.createElement(_designSystemWrapper.TableCell, null, onSelectAll ? /*#__PURE__*/_react.default.createElement(_designSystem.CheckBox, {
    style: {
      marginLeft: 5
    },
    ...
    sortBy: sortBy,
    direction: direction
  })), /*#__PURE__*/_react.default.createElement(_designSystemWrapper.TableCell, {
    key: "actions",
    style: {
      width: 80
    }

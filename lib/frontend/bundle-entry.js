...
var Interfaces = _interopRequireWildcard(require("./interfaces"));

var layoutElementParser = _interopRequireWildcard(require("./utils/layout-element-parser"));
...
var _default = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
  ...
  LayoutElementRenderer: _actions.LayoutElementRenderer,
  env
}, AppComponents), Hooks), Interfaces), layoutElementParser), {}, {
  flat: _flat.flat,

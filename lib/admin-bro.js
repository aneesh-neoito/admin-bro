...
const defaultOptions = {
  ...
  impersonatePath: _constants.DEFAULT_PATHS.impersonatePath,
  impersonateLogoutPath: _constants.DEFAULT_PATHS.impersonateLogoutPath,
  loginPath: _constants.DEFAULT_PATHS.loginPath,
  signupPath: _constants.DEFAULT_PATHS.signupPath,
  forgotPasswordPath: _constants.DEFAULT_PATHS.forgotPasswordPath,
  changePasswordPath: _constants.DEFAULT_PATHS.changePasswordPath,
  databases: [],
  resources: [],
  dashboard: {},
  login: {},
...
class AdminBro {
  ...
  async initialize() {
    if (process.env.NODE_ENV !== 'development' && !(process.env.ADMIN_BRO_SKIP_BUNDLE === 'true')) {
      console.log('AdminBro initialize'); // eslint-disable-next-line no-console
  ...
  async renderLogin({
    ...
    if (this.options.renderLogin) {
      return this.options.renderLogin(this, {
        action,
        errorMessage
      });
    } // if (process.env.NODE_ENV !== 'production') {

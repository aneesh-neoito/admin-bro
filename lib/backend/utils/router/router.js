...
const Router = {
  assets: [{
    ...
    path: '/frontend/assets/login.bundle.js',
    src: path.join(ASSETS_ROOT, `scripts/login-bundle.${_bundlerEnv.default}.js`)
  }, {
  ...
  {
    method: 'GET',
    path: '/public/{pageName}',
    Controller: _appController.default,
    action: 'public'
  }, {
    method: 'GET',
    path: '/public/api/resources/{resourceId}/actions/{action}',
    Controller: _apiController.default,
    action: 'resourceAction'
  }, {
    method: 'GET',
    path: '/public/api/resources/{resourceId}/actions/{action}/{query}',
    Controller: _apiController.default,
    action: 'resourceAction'
  }, {
    method: 'POST',

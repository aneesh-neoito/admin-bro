...
class BaseResource {
  ...
  setCurrentAdmin(currentAdmin) {
    return this._currentAdmin = currentAdmin;
  }
  ...
  roles() {
    throw new _utils.NotImplementedError('BaseResource#roles');
  }
  /**
  ...
  permissions() {
    throw new _utils.NotImplementedError('BaseResource#permissions');
  }
  /**
